...
namespace TodoWebAPIDesign.Controllers
{
    ...
    public class TodosController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult<Todo> Post([FromBody] CreateTodoModel createTodoModel)
        {
            ...
            Todo todo = new Todo(createTodoModel.Description, createTodoModel.IsCompleted);
